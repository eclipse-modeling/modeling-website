...
$App->AddExtraHtmlHeader('<link type="application/rss+xml" rel="alternate" title="M2M '.$trans[$projct].' Build Feed" href="http://www.eclipse.org/modeling/download.php?file=/'.$PR.'/feeds/builds-'.$projct.'.xml"/>' . "\n");
