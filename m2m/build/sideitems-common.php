...
function sidebar()
{
	...
	<div class="sideitem">
		...
		<ul>
			<li><a href="/<?php print $PR; ?>/<?php print $projct ? $projct : "atl"; ?>/build/">Build</a>,
				 <a href="/<?php print $PR; ?>/<?php print $projct ? $projct : "atl"; ?>/build/clean.php">Clean</a>,
	...
	<div class="sideitem">
		...
		<ul>
			...
			<li><a href="https://bugs.eclipse.org/bugs/buglist.cgi?product=M2M&amp;component=<?php echo $projct; ?>&amp;bug_status=RESOLVED&changedin=7">Resolved Bugs This Week</a></li>
