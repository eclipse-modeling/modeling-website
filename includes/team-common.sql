...
-- groups
-- [gid, Project, Component, GroupName, Path] (eg., 3, 'org.eclipse.emf','','modeling.emf.website','/home/data/httpd/*.eclipse.org/modeling/emf/')
...
INSERT INTO groups (project,component,groupname,path) VALUES 
	...
	('org.eclipse.emf','org.eclipse.emf','modeling.emf.website','/home/data/httpd/*.eclipse.org/modeling/emf/'),
	('org.eclipse.emf','org.eclipse.emf','modeling.emf.website','/home/data/httpd/*.eclipse.org/tools/emf/'),			-- deprecated but still in use (old update site & downloads)
