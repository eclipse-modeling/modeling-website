		...
		else
		{
			if ( (is_dir("../".$projects[$z]) || is_dir($projects[$z])) && !in_array($projects[$z],$extraprojects))
			{
				...
				if (!isset($hasmoved) || !array_key_exists($y,$hasmoved))
				{
					...
					if (!isset($nodownloads) || !in_array($projects[$z],$nodownloads))
					{
...
<div id="rightcolumn">
	...
	<div class="sideitem">
		<h6><a href="/modeling/m2t/feeds/"><img style="float:right" alt="Build Feeds" src="/modeling/images/rss-atom10.gif"/></a>
	...
	<div class="sideitem">
		...
		<a href="http://www.eclipse.org/modeling/m2t/">M2T</a> or any other part of the <a href="http://www.eclipse.org/modeling/">Modeling Project</a>? 
		Now you can!</p>
	...
	<div class="sideitem">
		...
		<ul>
			...
			<li><a href="http://wiki.eclipse.org/index.php/EMFT_Procedures">M2T Build &amp; Promote</a></li>
		</ul>
	</div>
...
$pageTitle = "Eclipse Modeling - M2T - Home";
...
?>
<!-- $Id: index.php,v 1.4 2007/06/21 19:36:20 nickb Exp $ -->
