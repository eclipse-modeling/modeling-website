...
if ($proj) { 
	header("Location: http://wiki.eclipse.org/index.php/M2T-" . strtoupper($proj) . "-FAQ"); 
	exit;
}
ob_start();
?>
...
$pageTitle = "Eclipse Modeling - M2T - FAQs";
$pageKeywords = ""; // TODO: add something here
$pageAuthor = "Neil Skrypuch";

$App->generatePage($theme, $Menu, $Nav, $pageAuthor, $pageKeywords, $pageTitle, $html);
?>
<!-- $Id: faq.php,v 1.1 2007/04/20 20:59:50 nickb Exp $ -->
