...
function sidebar()
{
	...
	<div class="sideitem">
		...
		<ul>
			...
			<li>QTV: <a href="/modeling/emf/<?php print $projct; ?>/build/">Build</a>, 
					 <a href="/modeling/emf/<?php print $projct; ?>/build/promo.php">Promote</a></li>
		</ul>
	...
	<div class="sideitem">
		<h6>Info</h6>
		<ul>
			<li><a href="https://bugs.eclipse.org/bugs/buglist.cgi?product=EMF,XSD,EMFT&amp;bug_status=ASSIGNED">Assigned Bugs</a></li>
