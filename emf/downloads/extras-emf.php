...
$oldrels = array(
	...
	"2.6.0" => "201006141136",
	"2.5.0" => "200906151043",
	"2.4.3" => array("201005200038","http://archive.eclipse.org/modeling/emf/emf/downloads/drops/2.4.3/M201005200038/"),
	"2.4.2" => "200902171115",
//	"2.4.1" => "200808251517",
//	"2.4.0" => "200806091234",
	"2.3.2" => "200802051830",
...
<div class="homeitem3col">
	...
	<table cellpadding="2" cellspacing="4" border="0" style="padding-left:10px;background-color:#e8e7dd;">
	...
	<tr><td>2.5<a href="<?php echo $reqNotePrefix; ?>#req_note_2">**</a></td><td>3.5</td><td>5.0</td>
		...
		<td rowspan="6" valign="top">
			<ul>
				<li style="border:0;padding:1px;list-style: none;"><a name="req_note_1">*</a> Eclipse is only required for EMF's tools.
					For runtime-only use, only a JRE is required.</li>
				<li style="border:0;padding:1px;list-style:none;"><a name="req_note_2">**</a> EMF 2.5.x <a href="http://bugs.eclipse.org/251402">no longer includes SDO</a>.</li>
				<li style="border:0;padding:1px;list-style:none;"><a name="req_note_3">***</a> EMF 2.3.x contains significant, though binary compatible,
					<a href="http://www.eclipse.org/modeling/emf/docs/#whatsnew">changes from previous releases</a>.</li>
				<li style="border:0;padding:1px;list-style:none;"><a name="req_note_4">****</a> If you are using Sun's 1.4 JRE, please see
