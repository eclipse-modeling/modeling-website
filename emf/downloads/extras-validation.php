...
<div class="homeitem3col">
	...
	<p>IBM is pleased to contribute translations for the Eclipse Modeling Development Tools subcomponent Validation.</p>
	<ul>
		<li>
			...
			<ul id="lang1_0">
				...
				<li>
					...
					<p>These translations are based on Validation 1.0.0. The NLS translation fragment packs should work with all subsequent 1.0.x maintenance releases, with any new strings remaining untranslated.</p>
				</li>
			</ul>
		</li>
	</ul>
...
?>
	<div class="homeitem3col">
		...
		<p>These are the minimum required downloads for using Validation:</p>
		<ul>
			<li>To use Validation, you require both the Validation &amp; <a href="/modeling/emf/downloads/?project=emf">EMF</a> Runtimes.</li>
			<li>To use Validation with OCL, you will also require the <a href="/modeling/mdt/downloads/?project=ocl">OCL</a> Runtime.</li>
		</ul>
