...
$third_party_works_with = array(
	"asm.jar 1.5.3, org.eclipse.emf.teneo.hibernate.libraries, <a href=\"http://asm.objectweb.org/license.html\">ObjectWeb License</a>, used for build/test; optional at runtime; not in CVS; not shipped, 2427, teneo",
	"bcel-5.1.jar, org.eclipse.emf.teneo.jpox.libraries, <a href=\"http://jakarta.apache.org/bcel/\">Apache</a> 2.0, used for build/test; optional at runtime; not in CVS; not shipped, 2435, teneo",
	"cglib-2.1.3.jar, org.eclipse.emf.teneo.hibernate.libraries, Apache 2.0, used for build/test; optional at runtime; not in CVS; not shipped, 2428, teneo",
	"commons-collections.jar 2.1.1, org.eclipse.emf.teneo.hibernate.libraries, Apache 2.0, used for build/test; optional at runtime; not in CVS; not shipped, 2429, teneo",
	"commons-logging.jar 1.0.4, org.eclipse.emf.teneo.hibernate.libraries, Apache 2.0, used for build/test; optional at runtime; not in CVS; not shipped, 2436, teneo",
	"dom4j-1.6.1.jar, org.eclipse.emf.teneo.hibernate.libraries, <a href=\"http://www.dom4j.org/license.html\">BSD style</a>, used for build/test; optional at runtime; not in CVS; not shipped, 2430, teneo",
	"hibernate3.jar 3.2.5 GA, org.eclipse.emf.teneo.hibernate, LGPL 2.1, used for build/test; optional at runtime; not in CVS; not shipped, 2431, teneo",
	"jdo2-api-2.0.jar, org.eclipse.emf.teneo.jpox.libraries, Apache 2.0, used for build/test; optional at runtime; not in CVS; not shipped, 2394, teneo", # also 2433
	"jpox-1.1.7.jar, old version; no longer used, Apache 2.0, used for build/test; optional at runtime; not in CVS; not shipped, 2393, teneo",
	...
	"jta.jar, org.eclipse.emf.teneo.hibernate.libraries, <a href=\"http://java.sun.com/products/jta/index.html\">Sun Binary License</a>, used for build/test; optional at runtime; not in CVS; not shipped, 2432, teneo",
