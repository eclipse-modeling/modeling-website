<?xml version="1.0" encoding="UTF-8"?>
     ...
     *                        - bug 241822 - fixed link to themes and priorities
     *                                       fixed preamble in themes so it renders 
     *******************************************************************************/
    -->
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="plan:themes_and_priorities">
        ...
        <xsl:apply-templates select="plan:preamble | plan:theme"/>
        <p><a href="#toc">Table of Contents</a></p>
        
    </xsl:template>
    
    <xsl:template match="plan:compatibility_with_previous_releases">
        <h2><a name="compatibility">Compatibility with Previous Releases</a></h2>
        <xsl:call-template name="copyNodeorCData">
            <xsl:with-param name="node" select="."/>
        </xsl:call-template>
        <p><a href="#toc">Table of Contents</a></p>
