...
<div class="homeitem3col">
	<h3>Build Compatibility</h3>
		...
		<p style="padding-left:10px"><b>S-build:</b> this build is for Eclipse 3.4/EMF 2.4</p>
		<br/>
	<p style="padding-left:10px">The I-build 0.7.5 build is for Eclipse 3.2 and EMF 2.2. However this build/branch is not actively maintained.</p>
</div>
<?php
}
?>