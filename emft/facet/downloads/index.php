...
$defaultProj = "";
unset($_GET["project"]); // EMF Facet has no subprojects, so this should be blank
...
$filePre = array( # use "/" because EMFFacet has no parent or child projects/components
	"/" => array("EMFFacet", "emffacet") // EMFFacet-sdk-*.zip
);
...
$pageTitle = "EMF Facet - Downloads";
$pageKeywords = "EMF Facet, download";
$pageAuthor = "Nicolas Bros"; // (copied from PDT, then from MoDisco)
