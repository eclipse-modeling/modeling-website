...
$filePre = array(
	/* "/newproj" => array("tmf-newproj", "tmf-oldproj"), */
);
...
if ($isBuildServer) { include_once $_SERVER["DOCUMENT_ROOT"] . "/modeling/tmf/build/sideitems-common.php"; }
...
$pageTitle = "Eclipse Modeling - TMF - $trans[$projct] - Downloads";
...
$App->AddExtraHtmlHeader('<link type="application/rss+xml" rel="alternate" title="TMF '.$trans[$projct].' Build Feed" href="http://www.eclipse.org/modeling/download.php?file=/'.$PR.'/feeds/builds-'.$projct.'.xml"/>' . "\n");
